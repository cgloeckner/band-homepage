...
<head>
    ...
    <link rel="shortcut icon" href="{{module.server.get_static_url('/content/shortcut-icon.png')}}" type="image/x-icon">
    <link rel="apple-touch-icon" href="{{module.server.get_static_url('/content/apple-touch-icon.png')}}">

%for css in ['normalize', 'layout', 'navigation', module_name]:
    %url = module.server.get_static_url('/' + css + '.css')
    <link rel="stylesheet" type="text/css" href="{{url}}">
%end

    <script src="https://code.jquery.com/jquery-3.6.3.slim.min.js"></script>
    <script src="{{module.server.get_static_url('/collapse.js')}}"></script>
