...
from . import server, modules, feed, releases, lineup, gigs, gallery, merch, presskit, seo, imprint, contact
...
class Homepage:
    def __init__(self, api: modules.BaseWebServer) -> None:
        ...
        # load imprint
        self.imprint = imprint.Imprint(api=api)
        self.imprint.render()

        # load contact
        self.contact = contact.Contact(api=api)
        self.contact.render()
